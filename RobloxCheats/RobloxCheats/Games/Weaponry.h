...
#define RBX_WEAPONRY_MAX_PLAYER_COUNT 20

void weaponry_cheat(task_t task)
{
    printf("- WEAPONRY -\n");
    ...
    static vm_address_t enemy_heads[RBX_WEAPONRY_MAX_PLAYER_COUNT];
