...
void field_of_battle_auto_farm(task_t task)
{
    ...
    printf("Heaven's Edge/Greatsword of flying II is highly recommended\n");
    ...
    static useconds_t target_switch_delay_time = 0;
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^
    {
        for (;;)
        {
            ...
            {
                //vm_write(task, handle_cframe_address + 0x24, (vm_offset_t)&npc_pos, sizeof(npc_pos));
