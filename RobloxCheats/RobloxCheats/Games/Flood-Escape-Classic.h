...
void generic_cheat(task_t task)
{
    ...
    static char jarvis_enabled = true;
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^
        ...
        for (;;)
        {
            ...
            //APPEND_ESP_OBJ(o, esp_color, "OBJ")
...
#pragma mark - stdin Inputs -
    ...
    @autoreleasepool {
        ...
        rd.recognizer.commands = @[@"Low Priority", //0
                                   @"High Priority", //1
        @"Fly", //2
        @"No Fly"]; //3
