...
#pragma mark - Loops -
    ...
    static tower_upgrade_info_t gold_scout_tui = {.max_lvl = 4, .lvl_costs = {250, 150, 500, 2325, 5500}};
...
#pragma mark Molten with scouts
            if (options.autofarm_type == RBX_TDS_AUTOFARM_TYPE_MOLTEN_WITH_SCOUTS_DEATH_FARM)
            {
                ...
                else if (options.should_return_to_lobby && rbx_textlabel_contains_text(task, __restartmatch_tl, "Play"))
                {
