...
get_globals: {};
    ...
    static rbx_cframe_t new_hrp_cframe = {
        ...
        .r10 = 0, .r11 = 1, .r12 = 0,
        .r20 = 0, .r21 = 0, .r22 = 1,
        .pos.x = 0, .pos.y = 10000, .pos.z = 0
    };
    static rbx_cframe_t new_camera_cframe = {.r0 = -1, .r1 = 0, .r2 = 0, .r10 = 0, .r11 = 0, .r12 = 1, .r20 = 0, .r21 = 1, .r22 = 0};
...
#pragma mark - Loops -
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^{
        for (;;)
        {
            ...
            {
                if (vm_read_8byte_value(task, task_base_address + RBX_PLACEID_OFFSET) == RBX_TDS_LOBBY_PLACE_ID)
                {
                    exit(0);
                }
            }
...
#pragma mark - Molten -
            ...
            if (mode_type == RBX_TDS_MODE_TYPE_MOLTEN)
            {
                ...
                {
                    //Wave 1
                    TDS_PLACE_TOWER_SAFE(placements[0]) //Place ace
                    ...
                    TDS_UPGRADE_UNTIL_LEVEL(1);
                    TDS_WAIT_WHILE_COND_AND_SKIP(time > 5 || time == 0, 40)
                    TDS_SELECT_TOWER_SAFE(placements[2])
                    TDS_UPGRADE_UNTIL_LEVEL(1);
                    TDS_PLACE_TOWER_SAFE(placements[3])
                    ...
                    TDS_UPGRADE_UNTIL_LEVEL(2);
                    TDS_PLACE_TOWER_SAFE(placements[4])
                    ...
                    TDS_SELECT_TOWER_SAFE(placements[4])
                    TDS_UPGRADE_UNTIL_LEVEL(3);
                    TDS_PLACE_TOWER_SAFE(placements[5])
                    TDS_WAIT_FOR_TOWER_LOAD(5)
                    TDS_WAIT_WHILE_COND(wave == 8)
                    //Wave 9
                    TDS_SELECT_TOWER_SAFE(placements[5])
                    TDS_UPGRADE_UNTIL_LEVEL(2);
                    ...
                    TDS_UPGRADE_UNTIL_LEVEL(3);
                    TDS_SELECT_TOWER_SAFE(placements[8])
                    TDS_UPGRADE_UNTIL_LEVEL(3);
                    ...
                    //Wave 17
                    TDS_PLACE_TOWER_SAFE(placements[9]) //PLACE DJ
                    ...
                    //Wave 21
                    TDS_PLACE_TOWER_SAFE(placements[10]) //PLACE COMMANDER
                    ...
                    //Wave 37
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[20])
                    TDS_WAIT_FOR_TOWER_LOAD(20)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[21])
                    TDS_WAIT_FOR_TOWER_LOAD(21)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[22])
                    TDS_WAIT_FOR_TOWER_LOAD(22)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND_AND_SKIP(time > 5 || time == 0, 54)
                    ...
                    TDS_WAIT_FOR_TOWER_LOAD(23)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[24])
                    TDS_WAIT_FOR_TOWER_LOAD(24)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND_AND_SKIP(time > 5 || time == 0, 54)
                    ...
                    TDS_WAIT_FOR_TOWER_LOAD(25)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[26])
                    TDS_WAIT_FOR_TOWER_LOAD(26)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[27])
                    TDS_WAIT_FOR_TOWER_LOAD(27)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[28])
                    TDS_WAIT_FOR_TOWER_LOAD(28)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND_AND_SKIP(time > 5 || time == 0, 54)
                    TDS_WAIT_WHILE_COND(wave == 39)
                    //Wave 40
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[29])
                    TDS_WAIT_FOR_TOWER_LOAD(29)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[30])
                    TDS_WAIT_FOR_TOWER_LOAD(30)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_WAIT_WHILE_COND(cash < 3000)
                    TDS_PLACE_TOWER_SAFE(placements[31])
                    TDS_WAIT_FOR_TOWER_LOAD(31)
                    TDS_UPGRADE_UNTIL_LEVEL(4)
                    TDS_SELECT_TOWER_SAFE(placements[10])
