...
tds_tower_placement_t molten_with_scouts_winter_abyss_placements[] =
{
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -3.982852, .y = 7.450755, .z = -10.538114}},    // [0] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -0.975503, .y = 7.450747, .z = -10.301587}},    // [1] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -2.537959, .y = 7.450632, .z = -7.733338}},    // [2] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = 0.558025, .y = 7.450344, .z = -7.694640}},    // [3] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -0.855523, .y = 7.450976, .z = -5.015756}},    // [4] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = 2.071736, .y = 7.450592, .z = -10.345094}},    // [5] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = 3.658897, .y = 7.450356, .z = -7.775187}},    // [6] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = 2.164734, .y = 7.450997, .z = -5.111619}},    // [7] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = 0.479860, .y = 7.450832, .z = -12.966736}},    // [8] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -2.515472, .y = 7.450875, .z = -13.223557}},    // [9] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -5.591338, .y = 7.450638, .z = -7.948121}},    // [10] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -4.192687, .y = 7.450979, .z = -5.185695}},    // [11] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -5.557253, .y = 7.450870, .z = -13.165279}},    // [12] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = 5.193428, .y = 7.450115, .z = -5.134722}},    // [13] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = -7.073855, .y = 7.450753, .z = -10.559323}},    // [14] Golden
    (tds_tower_placement_t){.type = 1, .pos = (vector3_t){.x = 2.243348, .y = 7.450794, .z = -15.420689}},    // [15] Golden
};
...
void* molten_with_scouts_map_dict[] = {
    ...
    "Winter Abyss", molten_with_scouts_winter_abyss_placements,
...
long molten_with_scouts_map_count = 9;
...
#define TDS_LOBBY_MOLTEN_CLICK TDS_CLICK(542, 292)
#define TDS_LOBBY_EASY_CLICK TDS_CLICK(158, 190)
