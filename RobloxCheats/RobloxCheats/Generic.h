...
#pragma mark - stdin Inputs -
    ...
    STDIN_INPUT_ENGINE({
        INSERT_STDIN_INPUT_SIMPLE("fly", fly_speed = true; rbx_smooth_fly_patch(task, task_base_address, true); printf("ENABLED FLY\n");)
        INSERT_STDIN_INPUT_SIMPLE("nofly", fly_speed = false; rbx_smooth_fly_patch(task, task_base_address, false); printf("DISABLED FLY\n");)
