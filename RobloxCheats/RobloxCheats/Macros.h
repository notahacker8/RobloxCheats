...
#define MOUSEMOVE(p)\
if (shared_memory->APP_IS_ACTIVE) {moveMouseOnWindow(shared_memory->WINDOW_X, shared_memory->WINDOW_Y, shared_memory->WINDOW_W, shared_memory->WINDOW_H, p);}
