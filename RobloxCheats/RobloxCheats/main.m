...
char* __LIBESP_DYLIB_PATH__ = ".../libESP.dylib";
char* __COOKIE_TXT_PATH__ = ".../roblox-cookie.txt";
char* __ROBLOX_PIPE_TXT_PATH__ = ".../roblox-pipe.txt";
...
void blox_fruits_pirate_raid_cheat(task_t task)
{
    blox_fruits_auto_farm(task, "Tanky", "", 15, '1', false, false, true, false, false, false, false, false);
}
...
int main(int argc, char** argv)
{
   ...
   // vm_address_t game = rbx_find_game_address(task);
    ...
    //blox_fruits_cheat(task);
    //phantom_forces_cheat(task);
    //blox_fruits_auto_farm(task, "Candy Pirate", "Candy Cane Quest Giver", 15, '1', true, true, true, false, false, false, false, false);
    //blox_fruits_pirate_raid_cheat(task);
