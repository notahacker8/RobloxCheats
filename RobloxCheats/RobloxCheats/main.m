...
int main(int argc, char** argv)
{
    ...
    //vm_address_t rt=p rbx_find_root_table(task);
    //vm_address_t p = rbx_root_table_lookup(task, rt, "Parent");
    //printf("%p\n", p);
    //gravity_cheat(task);
    //vm_address_t root_table = rbx_find_root_table(task);
    //find_function_offsets(task);
    //find_object_offsets(task);
    //blox_fruits_auto_farm(task, factory_raid);
    //blox_fruits_auto_farm(task, law_farm);
    //blox_fruits_auto_farm(task, bounty_undo);
    //blox_fruits_auto_farm(task, pirateai_raid);
    //blox_fruits_auto_farm(task, chrono_farm);
    //blox_fruits_auto_farm(task, follow_me);
