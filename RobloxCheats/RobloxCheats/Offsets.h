...
int RBX_PLACEID_OFFSET = 0x4d46030;
...
int RBX_TEXTLABEL_TEXT_OFFSET = 0x680;
...
int RBX_FRAME_VISIBLE_OFFSET = 0x338;
int RBX_BASEPART_PROPERTIES_CANCOLLIDE_OFFSET = 0x2e3;
...
int RBX_WHAT_GAME_POINTS_TO_OFFSET = 0x3E73C30;

//Find what set_parent jumps to, then find the function that it calls
int RBX_SET_PARENT_HOOK_OFFSET = 0x1D0ACA8;
...
int RBX_TOOL_ACTIVATE_METHOD_OFFSET = 0x14cd024;
int RBX_HUMANOID_HEALTH_GETTER_METHOD_OFFSET = 0xb7c6b4;
int RBX_HUMANOID_HEALTH_SETTER_METHOD_OFFSET = 0x743b58;
int RBX_HUMANOID_WALKSPEED_GETTER_METHOD_OFFSET = 0xb7c7a4;
int RBX_HUMANOID_WALKSPEED_SETTER_METHOD_OFFSET = 0x74313c;
int RBX_INSTANCE_SET_PARENT_METHOD_OFFSET = 0x1d1ec40;
