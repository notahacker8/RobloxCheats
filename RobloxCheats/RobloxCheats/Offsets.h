...
int RBX_WHAT_GAME_POINTS_TO_OFFSET = 0x4891338;
int RBX_PLACEID_OFFSET = 0x582fce8;
...
int RBX_TEXTLABEL_TEXT_OFFSET = 0xb48;
...
int RBX_FRAME_VISIBLE_OFFSET = 0x3c1;
...
int RBX_BYTES_TO_NOP_FOR_FLY_OFFSET = 0x130E244;
