...
int tds_get_cash(task_t task, vm_address_t cash_amount_text_label)
{
    ...
    vm_deallocate(task, (vm_address_t)text, len);
                     ...
                     int tower_number)
{
    ...
    wtsi = rbx_world_to_screen_point(camera_cframe, fov, pos, window_width, window_height);
    printf("%f %f\n", wtsi.x, wtsi.y);
    Input inputs[5];
                       ...
                       int tower_index)
{
    ...
    custom_rbx_world_to_screen_info_t wtsi;
    wtsi = rbx_world_to_screen_point(camera_cframe, fov, thrpcf.pos, window_width, window_height);
    printf("%f %f\n", wtsi.x, wtsi.y);
    Input inputs[6];
    float _x = wtsi.x + 60;
    float _y = wtsi.y + 47;
